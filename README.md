...
a)POP: total population for the subcounty
b)S_Yield_Ha: average yield for sorghum for the subcounty (Kg/Ha)
c)M_Yield_Ha: average yield for maize for the subcounty (Kg/Ha)
d)Crop_Area_Ha: total crop area for the subcounty (Ha)
e)S_Area_Ha: total sorghum crop area for the subcounty (Ha)
f)M_Area_Ha: total maize crop area for the subcounty (Ha)
g)S_Prod_Tot: total productivity for the sorghum for the subcounty (Kg)
h)M_Prod_Tot: total productivity for the maize for the subcounty (Kg)
